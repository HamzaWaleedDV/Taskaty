...
def main():
    ...
    # uncheck_task = subparsers.add_parser('uncheck', help='Uncheck your task')
    # uncheck_task.add_argument('-u', '--unchecked', help='Number of the task to be done. If not specified, last task will be removed', type=int)
    # uncheck_task.set_defaults(func= controller.uncheck_task)
